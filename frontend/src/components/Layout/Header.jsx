...
const Header = ({ activeHeading }) => {
  ...
  const [openCart, setOpenCart] = useState(false); //state for cart menu toggle
  const [openWishlist, setOpenWishlist] = useState(false); //state for wishlist menu toggle
  const [open, setOpen] = useState(false); //State for mobile header
          ...
          <div className="fixed w-full bg-[#0000005f] z-20 h-full top-0 left-0">
            <div className="fixed w-[60%] bg-[#fff] h-screen top-0 left-0 z-10 overflow-y-scroll">
              ...
              <div className={`${styles.button} ml-4 !rounded-[4px]`}>
                <Link to="/seller" className="text-[#fff] flex items-center">
                  <h1>
                    Become Seller <IoIosArrowForward className="ml-1" />
                  </h1>
                </Link>
              ...
              <div className="flex w-full justify-center">
                {isAuthenticated ? (
                  ...
                  <>
                    <Link
                      to="/login"
                      className="text-[18px] pr-[10px] text-[#000000bb] font-[600]"
                    >
                      Login /
                    </Link>
                    <Link
                      to="/sign-up"
                      className="text-[18px] text-[#000000b7] font-[600]"
                    >
                      Sign up
                    </Link>
                  </>
