...
const ProductDetails = ({ data }) => {
  ...
  const handleMessageSubmit = () => {
    navigate("/inbox?conversation=hsajdkflioajefsd");
  };
              ...
              <div className="w-full 800px:w-[50%] pt-5">
                ...
                <div className="flex items-center mt-12 justify-between pr-3">
                  <div>
                    ...
                    <span className="bg-gray-200 text-gray-800 font-medium px-4 py-[10px] pt-[9px]">
                      {count}
                    </span>
                    <button
                      className="bg-gradient-to-r from-teal-400 to-teal-500 text-white font-bold rounded-l px-4 py-2 shadow-lg hover:opacity-75 transition duration-300 ease-in-out"
                ...
                <div className="flex items-center pt-8">
                  ...
                  >
                    <span className="text-white flex items-cent">
      ...
      {active === 1 ? (
        <>
          ...
          <p className="py-2 text-[18px] leading-8 pb-10 whitespace-pre-line">
            ...
            debitis pariatur nisi molestias praesentium eligendi aliquam minus
            architecto? Autem explicabo modi dolor vero aperiam, sunt adipisci
            dignissimos nobis, id non delectus recusandae accusantium neque hic
            maxime nam? Repellat, optio distinctio.
          </p>
          ...
          <p className="py-2 text-[18px] leading-8 pb-10 whitespace-pre-line">
            ...
            architecto? Autem explicabo modi dolor vero aperiam, sunt adipisci
            dignissimos nobis, id non delectus recusandae accusantium neque hic
            maxime nam? Repellat, optio. Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Veniam tempora mollitia magni eaque reprehenderit
            labore asperiores laudantium et ea voluptas.
          </p>
        </>
      ) : null}
        ...
        <div className="w-full block 800px:flex p-5">
          <div className="w-full 800px:w-[50%]">
            <div className="flex items-center">
              <img
                className="w-[50[px] h-[50px] rounded-full "
                src={data.shop.shop_avatar.url}
                alt=""
              />
              <div className="pl-3">
            ...
            <p className="pt-2">
              ...
              doloremque architecto sapiente ullam ex fuga ratione accusantium
              sint, ipsa dolorum?
            </p>
          </div>
          ...
          <div className="w-full 800px:w-[50%] mt-5 800px:mt-0 800px:flex flex-col items-end ">
            <div className="text-left">
              <h5 className="font-[600]">
                Joined on: <span className="font-[500]">29 March, 2023</span>
              </h5>
