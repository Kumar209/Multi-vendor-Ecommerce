    ...
    <div className={`w-full block bg-white rounded-lg lg:flex p-2 mb-12`}>
      ...
      <div className="w-full lg:[w-50%] flex flex-col justify-center">
        ...
        <p>
          ...
          perspiciatis ipsam qui magni expedita quia aliquid doloribus itaque ab
          voluptatibus! 
          Lorem ipsum dolor sit amet, consectetur adipisicing
          elit. Maiores nobis saepe alias minus corrupti iure recusandae odit
          ducimus corporis? Ea.
        </p>
        ...
        <div className="flex py-2 justify-between">
            ...
            <span className="py-3 font-[400] text-[17px] text-[#44a55e]">
                120 sold
            </span>
        </div>
